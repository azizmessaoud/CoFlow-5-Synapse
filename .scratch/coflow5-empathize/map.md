...
- [Insight → Evidence → Metric](research/insight-evidence-alignment.md): I-1…I-10 checked detail-by-detail; Table 9 ▲ excluded; rejected framings (drivers-as-EVP-obstacle; volume-as-emissions) recorded. Evidence bar: [03-evidence-bar.md](issues/03-evidence-bar.md) resolved.
